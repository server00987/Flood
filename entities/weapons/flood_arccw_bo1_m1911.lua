...
SWEP.Hook_ModifyBodygroups = function(wep, data)
    ...
    local finish = finish_info[wep.Attachments[6].Installed] or 0
...
SWEP.Hook_TranslateAnimation = function(wep, anim, data)
    local bo2 = wep.Attachments[7].Installed == "bo1_m1911_sound_bo2"
    local cod4 = wep.Attachments[7].Installed == "bo1_m1911_sound_cod4"
