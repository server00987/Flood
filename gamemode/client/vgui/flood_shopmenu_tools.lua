...
function PANEL:Init()
	...
	if self.GmodTools then
		...
		LocalPlayer():ChatPrint(translate.Get("SHOP_ERROR7"))
	end
end
...
function PANEL:AddCategory(Name, Label, tItems)
	...
	Category.Paint = function(self, w, h)
		draw.RoundedBox(4, 0, 0, w, h, Color(255, 250, 250, 255))
		draw.RoundedBoxEx(4, 0, 0, w, self.Header:GetTall(), Color(50, 155, 220, 255), true, true, false, false)
	end
...
function PANEL:CreateCP( button ) 
	...
	cp.Paint = function(self, w, h)
		draw.RoundedBox(0, 0, 0, w, h, Color(255, 250, 250, 255))
		draw.RoundedBox(4, 0, 0, w, self.Header:GetTall(), Color(50, 155, 220, 255))
	end
